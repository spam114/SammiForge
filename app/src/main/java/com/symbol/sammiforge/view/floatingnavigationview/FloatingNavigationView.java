package com.symbol.sammiforge.view.floatingnavigationview;
...
public class FloatingNavigationView extends FloatingActionButton {
    ...
    public FloatingNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // Custom attributes
        TypedArray a = context.obtainStyledAttributes(attrs, com.andremion.floatingnavigationview.R.styleable.FloatingNavigationView);
        mDrawMenuBelowFab = a.getBoolean(com.andremion.floatingnavigationview.R.styleable.FloatingNavigationView_drawMenuBelowFab, false);
        a.recycle();
    }
